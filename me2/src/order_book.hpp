...
{
public:
    void match(fun::client::Side side, fun::client::Price price, fun::client::Volume& volume, std::vector<fun::client::Trade>& trades);
    void add_order(fun::client::Xoid ex_order_id, fun::client::Side side, fun::client::Price price, fun::client::Volume volume);
