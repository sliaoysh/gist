...
void order_book::add_order(const fun::client::Xoid ex_order_id, const fun::client::Side side, const fun::client::Price price, fun::client::Volume& volume, std::vector<fun::client::Trade>& trades)
{
